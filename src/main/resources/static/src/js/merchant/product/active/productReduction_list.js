$(function () {
    ...
    layui.use(["table", "element", "layer", "util"], function () {
        ...
        table.render({
            ...
            page: true,
            url: "/merchant/productActiveReduction/getProductActiveReductionListByMid/" + userId,
            title: "满减优惠商品",
            response: {
                statusCode: 200
            },
                ...
                case 'delete':
                    layer.confirm('你确定要删除这个活动嘛？', {
                        ...
                        btn1: function (index, layero) {
                            $.ajax({
                                url: "/merchant/productActiveReduction/deleteProductActiveDiscountById/" + data.fid,
                                type: "POST",
                                data:{
                                    _method:"DELETE"
                                },
                    ...
                    break;
                case 'edit':
                    location.href = "/merchant/productActiveReduction/editorProductActiveReductionById/" + data.fid;
                    break;
            }
        });
    });
